// INITIAL version of this file was created in 2021 (with some updates in 2023) and then used within feature "circle_pack_zoomed" based on Tracks.JSON file after parsing by `itunes-data` NodeJS package
// As of July-2025, now is used another NodeJS package `plist`
...
export function iTunesDataToCamelCase(data) {
  ...
  newData.disabled = Boolean(data.Disabled);
